...
public class Main {
    ...
    public static boolean isPalindrome(int number)
    {
        ...
        int reverse = 0;
        while(number !=0) {
            int digit = number % 10;  //First, we find the remainder of the given number by using the modulo (%) operator.
            reverse = (reverse * 10) + digit;//Multiply the variable reverse by 10 and add the remainder into it.
            number = number / 10; //Divide the number by 10. (To extract the remaining number)
        }
